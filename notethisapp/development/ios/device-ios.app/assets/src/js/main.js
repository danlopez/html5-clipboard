...
forge.logging.info("Debug is enabled.  Open https://trigger.io/catalyst/target/target-script-min.js#7E6BD5B7-FA9A-4D57-AD2F-A524C2A42883 if it isn't already!");
forge.enableDebug();
$(function () {
    'use strict';

    forge.logging.info("In the beast!");
    ...
    */
    ...
    function initialize(updateList) {
        var exists;
        forge.logging.info("Initializing Notes");
        ...
        fixSidebar();
        forge.logging.info("Done Initializing");
    }

    function loggedOutSetup() {
        forge.logging.info("Setting up Dropdowns");
